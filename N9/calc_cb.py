...
meas = [fullgraph9_inv, num_qubits, num_meas_layers, []]
...
# Save CB
with open(f'cb_{ansatz}/N{num_qubits}_L{num_meas_layers}_cb.pkl', 'wb') as file:
    pickle.dump(cb, file)
with open(f'cb_{ansatz}/N{num_qubits}_L{num_meas_layers}_sensor.pkl', 'wb') as file:
